...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      "logs.source": "Source",
      "logs.file": "Upload a file",
      "logs.stored": "Stored logs",
      "logs.refresh": "Refresh list",
      "logs.events": "{n} events · {c} cases",
      "logs.none": "No stored logs yet",
    ...
    ru: {
      ...
      "logs.file": "Загрузить файл",
      "logs.stored": "Сохранённые логи",
      "logs.refresh": "Обновить список",
      "logs.events": "{n} событий · {c} кейсов",
      "logs.none": "Сохранённых логов пока нет",
    ...
    kk: {
      ...
      "logs.source": "Дереккөз",
      "logs.file": "Файл жүктеу",
      "logs.stored": "Сақталған журналдар",
      "logs.refresh": "Тізімді жаңарту",
      "logs.events": "{n} оқиға · {c} кейс",
      "logs.none": "Сақталған журналдар әзірге жоқ",
